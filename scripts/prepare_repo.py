...
VIVADO_PROJECT = ROOT / "Vivado" / "RISC_V"

# Orígenes
SRC_MEMORY = ROOT / "memory"
SRC_HDL = VIVADO_PROJECT / "RISC_V.srcs" / "sources_1" / "new"
SRC_BD = VIVADO_PROJECT / "design_1.tcl"
SRC_CONSTRAINTS = VIVADO_PROJECT / "RISC_V.srcs" / "constrs_1" / "new"
SRC_IPS = VIVADO_PROJECT / "RISC_V.srcs" / "sources_1" / "ip"

SRC_SIM_1 = VIVADO_PROJECT / "RISC_V.srcs" / "sim_1" / "new"
